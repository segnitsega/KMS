      ...
      <div className="mb-6">
        <div className="flex mt-0 space-x-3">
          ...
          <div className="flex-1">
            <div className="text-bold text-[16px] font-semibold">
              {props.name}
            </div>
            <div className="flex space-x-2 mt-1 mb-1">
              ...
              <span className="text-sm m-0.5 text-gray-600">
                {props.department}
              </span>
            </div>
        ...
        <div className="flex-1 min-h-0 overflow-hidden">
          ...
          <div className="flex flex-wrap overflow-y-auto max-h-[60px] w-fit gap-1 mt-1">
            <span className="px-1 text-[11px] py-1 bg-blue-50 text-blue-700 whitespace-nowrap rounded-full">
              {props.skill1}
            </span>
            {props.skill2 && (
              <span className="px-2 text-[11px] py-1 bg-blue-50 text-blue-700 whitespace-nowrap rounded-full">
                {props.skill2}
              </span>
            )}
            {props.skill3 && (
