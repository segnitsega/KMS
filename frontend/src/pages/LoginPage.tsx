      ...
      <div className="w-full max-w-4xl bg-gradient-to-r from-blue-900 via-blue-800 to-cyan-800 rounded-3xl overflow-hidden shadow-2xl">
        <div className="grid md:grid-cols-2 min-h-[600px]">
          ...
          <div className="p-8 md:p-12 flex flex-col justify-center bg-blue-900/50 backdrop-blur-sm">
            <div className="mb-8">
<Link to= "/" className="inline-flex items-center text-cyan-300 hover:text-cyan-200 transition-colors mb-6">
                <ArrowLeft className="w-4 h-4 mr-2" />
                Back to Home
              </Link>
              <h1 className="text-3xl font-bold text-white mb-2">Welcome to our Community </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember" className="ml-2 text-blue-200 text-sm">
                  Remember me
                </label>
              </div>
